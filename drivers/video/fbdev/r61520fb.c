...
static void lcdc_gpio_wr(uint32_t is_data, uint32_t val)
{
  uint32_t ret;
...
static int panel_init(void)
{
  ...
  case 3:
    ...
    gpio_wr_dat(0x1020);
    gpio_wr_cmd(0x90);
    gpio_wr_dat(0x001f); // 80hz, 0x0016
    gpio_wr_cmd(0x10);
...
MODULE_DESCRIPTION("Allwinner f1c500s framebuffer driver for Miyoo handheld");
